...
For our analysis of the asteroids in \tess, we use sectors \red{TODO} %TODO
...
is applied, otherwise the lightcurve is indistinugshable from noise. %* This is emperical from match to LCDB, should that fig be here?
...
While our Nyquist limit is well above the spin barrier of \citet{Pravec2000} thanks to \tess's fast cadence, most asteroids discoverd above the barrier are small%TODO CITE Warner2009 LCDB?
, and therefore dim.
