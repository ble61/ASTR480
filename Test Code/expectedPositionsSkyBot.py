...
myTargetPos = [301.60, -38.68,
               Time("2020-04-17T00:00:00.000", format='isot', scale='utc')]
magLim = 20.0
res, times = querySB(myTargetPos, magLim=magLim)

resFig, resFig2 = plotExpectedPos(
    res, times, myTargetPos, magLim=magLim, scaleAlpha=True)
